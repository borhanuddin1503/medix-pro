...
export default function DoctorCard({ doctor }: { doctor: IDoctor }) {
    return (
        <div className="group overflow-hidden dark:border-gray-700 h-full rounded-3xl border border-main/10 bg-background shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-xl">
