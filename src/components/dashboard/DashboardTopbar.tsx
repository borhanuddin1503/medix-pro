...
export default function DashboardTopbar({
    ...
    return (
        <header className="py-4 z-30 flex shrink-0 items-center justify-between border-b border-main/10 dark:border-gray-700 bg-background/95 px-4 backdrop-blur md:px-6 lg:px-8">
